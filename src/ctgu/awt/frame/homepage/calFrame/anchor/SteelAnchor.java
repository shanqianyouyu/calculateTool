...
//		Icon icon1 = new ImageIcon("./resources/anchor/anchor8.png");
		...
		lblA.setBounds(10, 179, 237, 18);
		panel_1.add(lblA);

		JLabel lblB = new JLabel("钢板地锚的宽度 b :");
		lblB.setBounds(10, 210, 237, 18);
		panel_1.add(lblB);
		...
		textField_3.setBounds(268, 176, 136, 24);
		panel_1.add(textField_3);

		textField_4 = new JTextField(String.valueOf(sAnchor.b));
		textField_4.setColumns(10);
		textField_4.setBounds(268, 207, 136, 24);
		...
		lblCm.setBounds(418, 179, 64, 18);
		panel_1.add(lblCm);

		JLabel label_7 = new JLabel("cm");
		label_7.setBounds(418, 210, 64, 18);
		panel_1.add(label_7);

		JRadioButton radioButton = new JRadioButton("5T地锚");
		radioButton.setBounds(79, 140, 93, 27);
		panel_1.add(radioButton);

		JRadioButton radioButton_1 = new JRadioButton("10T地锚");
		radioButton_1.setBounds(193, 140, 93, 27);
		...
		label_10.setBounds(10, 134, 85, 18);
...
//		ButtonGroup buttonGroup = new ButtonGroup();
		...
		label_9.setBounds(14, 13, 114, 18);
		panel_2.add(label_9);

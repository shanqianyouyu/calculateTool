...
public class DerrickFrameN2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DerrickFrameN2 frame = new DerrickFrameN2();
	...
	public DerrickFrameN2() {
		...
		JLabel lblNewLabel = new JLabel("斜材规格:");
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				DerrickN1 derrickN = new DerrickN1();
				derrickN.x3 = RetaminResult;
				derrickN.x4= RetaminResult1;
				setVisible(false);
			}
		});

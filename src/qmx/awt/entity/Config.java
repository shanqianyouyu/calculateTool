...
import qmx.awt.main.calFrame.FatherTabbedPane;
...
public class Config {
	...
	// 每进行一次计算，后台就记录一个窗口
	public static TreeMap<Integer, FatherFrame> calFrames = new TreeMap<Integer, FatherFrame>(new Comparator<Integer>() {
